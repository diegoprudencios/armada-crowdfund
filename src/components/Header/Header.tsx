...
const ArmadaLogo = () => (
  <svg width="132" height="32" viewBox="0 0 132 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
    ...
    />
    <defs>
      <linearGradient id="lg0" x1="16" y1="32" x2="16" y2="0" gradientUnits="userSpaceOnUse">
        <stop stopColor="#F8D197" />
        <stop offset="1" stopColor="#CA8AEA" />
      </linearGradient>
      <linearGradient id="lg1" x1="16" y1="32" x2="16" y2="0" gradientUnits="userSpaceOnUse">
        <stop stopColor="#F8D197" />
        <stop offset="1" stopColor="#CA8AEA" />
      </linearGradient>
      <linearGradient id="lg2" x1="16" y1="32" x2="16" y2="0" gradientUnits="userSpaceOnUse">
        <stop stopColor="#F8D197" />
        <stop offset="1" stopColor="#CA8AEA" />
      </linearGradient>
      <linearGradient id="lg3" x1="16" y1="32" x2="16" y2="0" gradientUnits="userSpaceOnUse">
        <stop stopColor="#F8D197" />
        <stop offset="1" stopColor="#CA8AEA" />
      </linearGradient>
      <linearGradient id="lg4" x1="16" y1="32" x2="16" y2="0" gradientUnits="userSpaceOnUse">
        <stop stopColor="#F8D197" />
        <stop offset="1" stopColor="#CA8AEA" />
      </linearGradient>
      <linearGradient id="lg5" x1="16" y1="32" x2="16" y2="0" gradientUnits="userSpaceOnUse">
        <stop stopColor="#F8D197" />
        <stop offset="1" stopColor="#CA8AEA" />
      </linearGradient>
      <linearGradient id="lg6" x1="16" y1="32" x2="16" y2="0" gradientUnits="userSpaceOnUse">
        <stop stopColor="#F8D197" />
        <stop offset="1" stopColor="#CA8AEA" />
      </linearGradient>
    </defs>
