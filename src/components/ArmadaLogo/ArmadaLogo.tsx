export function ArmadaLogo() {
  return (
    <svg
      ...
      role="img"
    >
      <path d="M16.0001 32L13.405 29.405H18.5951L16.0001 32Z" fill="url(#armada-lg0)" />
      <path d="M20.3249 27.6752H11.6752L9.51334 25.5134H22.4868L20.3249 27.6752Z" fill="url(#armada-lg1)" />
      <path d="M16.0005 23.7837H7.78361L5.62103 21.6211H13.8379L16.0005 23.7837Z" fill="url(#armada-lg2)" />
      <path d="M24.2164 23.7837H16.0009L18.1634 21.6211H26.379L24.2164 23.7837Z" fill="url(#armada-lg3)" />
      <path d="M12.1081 19.8914H3.8913L1.72943 17.7296H9.94628L12.1081 19.8914Z" fill="url(#armada-lg4)" />
      <path d="M28.1087 19.8914H19.8932L22.055 17.7296H30.2706L28.1087 19.8914Z" fill="url(#armada-lg5)" />
      <path d="M32 15.9997H23.7845L16.0007 8.21604L8.21685 15.9997H0L16.0001 0L32 15.9997Z" fill="url(#armada-lg6)" />
      <path
