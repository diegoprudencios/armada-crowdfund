...
const LIGHT_LOGO_SRC = `${import.meta.env.BASE_URL}armada-logo-light.png`
...
function ArmadaMark({ tone = 'brand' }: { tone?: 'brand' | 'white' }) {
  const fill = tone === 'white' ? 'currentColor' : undefined
